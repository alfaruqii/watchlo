    ...
    <>
      <div
        className={`${isScrolled ? theme === "garden" ? "bg-base-100/80 backdrop-blur-lg" : "bg-black/80 backdrop-blur-lg" : "bg-base-100"} sticky top-0 z-50 flex items-center justify-between px-4 py-2 drop-shadow-lg transition-all duration-300
          sm:px-12`}
      >
        <div className={`drop-shadow-lg ${theme === "garden" ? "text-black" : "text-white"}`}>
          <Link href="/">
        ...
        <div className="flex items-center gap-2">
          <button className={`${theme === "garden" ? "border-gray-800" : "border-gray-300"} btn btn-sm rounded border-2 drop-shadow`}>
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
